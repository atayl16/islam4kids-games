...
export default defineConfig({
  plugins: [
    ...
    VitePWA({
      ...
      manifest: {
        name: "Islam4Kids Educational Games",
        short_name: "Islam4Kids",
        description: "Fun Islamic educational games for children - Word puzzles, quizzes, memory games and more!",
        theme_color: "#2b580c",
